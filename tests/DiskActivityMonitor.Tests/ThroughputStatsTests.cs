...
public class ThroughputStatsTests
{
    ...
    [Fact]
    public void Compute_MonitoredIdleMinutesCountAsZero()
    {
    ...
    [Fact]
    public void Compute_UnmonitoredWallClockGapDoesNotDiluteStats()
    {
        var s = ThroughputStats.Compute(new long[] { 600_000_000 }, 1);
        Assert.Equal(10.0, s.AverageMbps, 6);
        Assert.Equal(10.0, s.MedianMbps, 6);
    }
